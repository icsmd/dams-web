...
const onSubmit = async () => {
    ...
    const response1 = await axios.delete(`v1/person/${params.actionParams.person_id}`, params.actionParams);
...
onBeforeMount(() => {
	model.dialog = modalState.value === 'delete-person-modal' ? true : false
})
</script>
