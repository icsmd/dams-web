<template>
    <v-app-bar color="blue-grey-lighten-4">
        <div class="text-h6 pl-4 pr-3 text-uppercase">Document List</div>
...
const getBreadcrumbs = [
    ...
    { title: 'Document List', disabled: false, href: '' },
];

const headers = [
    { title: 'Document No.', key: 'docNo', class: 'text-center' },
    { title: 'Description', key: 'desc', class: 'text-center' },
    { title: 'Type', key: 'type', class: 'text-center' },
    { title: 'Actions', key: 'actions', sortable: false, class: 'text-center' },
];

const items = ref([
    { docNo: 'DN-2025-06-00001', desc: 'Document 1 Description', type: 'Confidential' },
    { docNo: 'DN-2025-06-00002', desc: 'Document 2 Description', type: 'Top Secret' },
    { docNo: 'DN-2025-06-00003', desc: 'Document 3 Description', type: 'Confidential' },
]);
...
const create = () => {
    router.push({ name: 'document-management-create' });
};
