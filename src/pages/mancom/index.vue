...
const headers = [
    ...
    { title: 'Event Title', key: 'event_title', class: 'text-center' },
    { title: 'Venue', key: 'event_venue', class: 'text-center' },
    { title: 'Event Date', key: 'event_date', class: 'text-center' },
    { title: 'Event Time', key: 'event_date', sortable: false, class: 'text-center' },
